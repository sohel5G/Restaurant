...
This form custom code by self for the field validation 
                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleRegisterUser} >
                        ...
                        <input
                            ...
                            type="submit"
                            className="bg-black text-white cursor-pointer w-full  font-medium rounded-lg text-sm px-5 py-2.5 text-center border"
                        />
